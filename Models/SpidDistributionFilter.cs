...
public sealed class SpidTraitFilters
{
    ...
    public override string ToString()
    {
        ...
        if (IsFemale == true) parts.Add("Female");
        else if (IsFemale == false) parts.Add("Male");
        
        if (IsUnique == true) parts.Add("Unique");
        else if (IsUnique == false) parts.Add("Non-Unique");
        
        if (IsSummonable == true) parts.Add("Summonable");
        if (IsChild == true) parts.Add("Child");
        else if (IsChild == false) parts.Add("Adult");
        if (IsLeveled == true) parts.Add("Leveled");
        if (IsTeammate == true) parts.Add("Teammate");
        if (IsDead == true) parts.Add("Dead");
